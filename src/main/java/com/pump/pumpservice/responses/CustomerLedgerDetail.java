...
public class CustomerLedgerDetail {
    ...
    public CustomerLedgerDetail() {//empty
    }

    public CustomerLedgerDetail(CustomerLedger customerLedger) {
    ...
    public List<CustomerLedgerCreditDebit> getCustomerLedgerCreditDebits() {
        return customerLedgerCreditDebits;
    }

    public void setCustomerLedgerCreditDebits(List<CustomerLedgerCreditDebit> customerLedgerCreditDebits) {
        this.customerLedgerCreditDebits = customerLedgerCreditDebits;
    }
}
